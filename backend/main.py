...
from pydantic import BaseModel
from evaluation import _automatic_prompt
from evaluation import _evaluation
from utility import env_manager
...
def generate(item: Item):
    ...
    generator = _automatic_prompt(item.num_test_output, item.objective, item.output)
    ...
    for prompt in prompts:
        ...
        # Run the evaluation
        evaluator = _evaluation(env_manager, client)
